...
@section('content')
            ...
            <div class="col-md-12">
                ...
                <table class="blueTable">
                    ...
                    <tr>
                            ...
                            <table class="sub-skills-table">
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="top">
                                        <a href="/company/skills/editSkill/{{$skill->id}}" class=" icon-c-ed"></a>
                                        <a data-toggle="modal"
                                           class="icon-c-del"
                                           data-target="#deleteSkill"
                                           onclick="deleteUrl = '/company/skills/deleteSkill/{{$skill->id}}'"></a>
                                    </td>
                                </tr>
                                        <?php $j++; ?>
                                    @endforeach
                        ...
                        <td align="right" valign="top">
                            <a href="/company/skills/editSkillsCat/{{$cat->id}}" class=" icon-c-ed"></a>
                            <a data-toggle="modal"
                               class="icon-c-del"
                               data-target="#deleteSkill"
                               onclick="deleteUrl = '/company/skills/deleteSkillsCat/{{$cat->id}}'"></a>
                        </td>
                    </tr>
                            <?php $i++; ?>
                   @endforeach
    ...
    @include('company.modals.delete-skill')
